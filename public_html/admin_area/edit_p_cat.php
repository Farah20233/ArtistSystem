...
<i class="fa fa-dashboard"></i> Dashboard / Edit Artwork Style
...
<i class="fa fa-money fa-fw" ></i> Edit Artwork Style
...
<label class="col-md-3 control-label" >Display as Trending Artwork Style </label>
...
echo "<script>alert('Artwork Style has been Updated')</script>";
