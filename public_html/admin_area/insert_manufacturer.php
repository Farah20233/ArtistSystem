...
<i class="fa fa-dashboard"></i> Dashboard / Insert Artist
...
<i class="fa fa-money fa-fw"> </i> Insert Artist
...
<label class="col-md-3 control-label"> Display as Trending Artist </label>
...
<label class="col-md-3 control-label"> Select Artist Image </label>
