...
<a href="#">
Total Cart Price: <span class="subtotal-cart-price"><?php total_price(); ?></span>, Total Items <?php items(); ?>
</a>
...
<p style="margin-top:8px;"> <strong> Artist : </strong> <?php echo $vendor_name; ?> </p>
...
<div class="col-md-3 col-sm-3"><!-- col-md-3 col-sm-6 Starts -->

<div class="box same-height headline"><!-- box same-height headline Starts -->

<h3 > Checkout these artworks! </h3>
...
<div class='col-md-3 col-sm-2 center-responsive' >
