...
<p id="paypal_desc" class="text-muted">Pay via PayPal</p>
...
data-name="Artiste-Art Assistant.com"
...
<input type="hidden" name="return" value="http://artistewebsite.com/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total_cart_price; ?>">

<?php }else{ ?>

<input type="hidden" name="return" value="http://artistewebsite.com/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total; ?>">

<?php } ?>

<input type="hidden" name="cancel_return" value="http://artistewebsite.com/checkout.php">
