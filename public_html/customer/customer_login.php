...
<p class="lead" >Existing User? Login </p>
...
<input type="text"  placeholder="Your E-mail"class="form-control" name="c_email" required >
...
<input type="password" placeholder="********"  class="form-control" name="c_pass" required >
