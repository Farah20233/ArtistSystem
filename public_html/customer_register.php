...
<a href="index.php" class="btn btn-linkbtn-sm" >
...
<a href="#">
Total Cart Price: <?php total_price(); ?>, Total Items <?php items(); ?>
</a>
...
<a href="customer_register.php"> Join us </a>
...
<div class="col-md-3" ><!--- col-md-12 Starts -->
...
<h2> New here?</h2>
<h3>Sign up and discover great amount of new opportunities!</h3>
</center><!-- center Ends -->
...
<input type="text" class="form-control" placeholder="Your Name" name="c_name" value="<?php echo @$_POST["c_name"]; ?>" required>
...
<input type="email" class="form-control" placeholder="Your E-Mail" name="c_email" value="<?php echo @$_POST["c_email"]; ?>" required>
...
<input type="text" class="form-control" placeholder="Username"  name="c_username" value="<?php echo @$_POST["c_username"]; ?>" required>
...
<input type="password" class="form-control"  placeholder="********"  id="pass" name="c_pass"  required>
...
<input type="password" class="form-control confirm" placeholder="********"   id="con_pass" required>
...
<input type="text" class="form-control" placeholder="Contact Number"  name="c_contact" value="<?php echo @$_POST["c_contact"]; ?>" required>
...
<div class="form-group"> <center><!-- form-group Starts -->

<label> User  Role </label>

<br>

<input type="radio" name="c_role" value="customer" required> Customer

<input type="radio" name="c_role" value="vendor" required>  Artist

</div><!-- form-group Ends --> </center>
...
<div class="g-recaptcha" data-sitekey="6LdrxtsaAAAAAIo69hRjiOwLtiAYrUs5gTT3_UAL" ></div>
...
$from = "farahshaheend@gmail.com";

$message = "

<h2>
Email Confirmation By artistewebsite.com $c_name
</h2>

<a href='http://artisteWebsite.com/customer/my_account.php?$customer_confirm_code'>
