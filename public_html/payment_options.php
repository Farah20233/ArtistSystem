...
<input type="hidden" name="business" value="artisteartassistant@gmail.com">
...
"http://artistewebsite.com/paypal_order.php?c_id=<?php echo $customer_id; ?>">

<input type="hidden" name="cancel_return" value="https://artistewebsite.com/index.php">
