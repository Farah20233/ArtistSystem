...
<label class="control-label"> Artwork Title </label>
...
<label> Artwork  Tabs </label>

<ul class="nav nav-tabs"><!-- nav nav-tabs Starts -->

<li class="active">

<a data-toggle="tab" href="#description"> Artwork Description </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Artwork Features </a>
...
<label> Artwork Weight <small> (kg)</small> </label>
...
<label> Artwork  Sale Price </label>
...
<label> Select An Artwork Type </label>
...
<label> Artwork Inventory Stock Management </label>
