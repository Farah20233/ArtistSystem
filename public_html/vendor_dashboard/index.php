...
<a href="index.php"> Artist Dashboard </a>
...
<img src="images/logo-small.png" alt="Artiste-Art Assistant logo" class="visible-xs" >
...
echo "<h3 class='text-center'> Confirm Your Email, To Access Your Dashboard!. </h3>";
